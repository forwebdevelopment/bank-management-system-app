...
export class AccountDireAccountList {
   ...
   // Receives the filter values emitted from your custom search element panel
  @Input() activeFilters?: FilterCriteria;

  @ViewChild(MatPaginator) paginator!: MatPaginator;
  // Output event to send criteria data to the parent data-table component
  ...
  dataSource = new MatTableDataSource<AccountRecord>(this.rawData);
